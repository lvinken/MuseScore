...
QString mxmlNoteDuration::checkTiming(const QString& type, const bool rest, const bool grace)
      ...
      qDebug("_specDura isValid %d value %s", _specDura.isValid(), qPrintable(_specDura.print()));
      qDebug("_calcDura isValid %d value %s", _calcDura.isValid(), qPrintable(_calcDura.print()));
      ...
      qDebug("_dura %s", qPrintable(_dura.print()));
